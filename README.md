...
현장 이슈와 요구사항을 기능 정책, 화면 UX, 데이터 흐름, 운영 문서로 구체화해 실제 운영자가 쓰는 제품으로 연결하는 역할을 맡고 있습니다.
...
- **뉴비(Neubie) 주행 시스템 운용 및 안정화**
  - Nav2 bringup, keepout/narrow mode 전환, docking/undock, elevator board/alight 액션 운용
